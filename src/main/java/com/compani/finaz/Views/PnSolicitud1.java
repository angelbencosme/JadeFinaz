...
public class PnSolicitud1 extends javax.swing.JPanel implements MenuAccion, ConsultaIinterface<Object> {
    ...
    private void btBuscarSolicitudActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscarSolicitudActionPerformed
        try {
            ...
            Logger.getLogger(PnSolicitud1.class.getName()).log(Level.SEVERE, null, ex);
        }
